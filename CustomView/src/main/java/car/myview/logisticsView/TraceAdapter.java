package car.myview.logisticsView;
...
public class TraceAdapter extends RecyclerView.Adapter<TraceAdapter.TraceViewHolder> {
    ...
    public void onBindViewHolder(TraceViewHolder holder, int position) {
        ...
        if (type == TYPE_CURR) {
            holder.acceptStationTv.setTextColor(mContext.getResources().getColor(R.color.color_3));
            holder.dotIv.setImageResource(R.mipmap.refund_iocn_pb);
