...
public class RushBuyCountDownTimerView extends LinearLayout {
     ...
     * @param color
     */
    public void setLLColor(View view, String color) {
        LinearLayout ll_d=view.findViewById(R.id.ll_day);
        LinearLayout ll_h=view.findViewById(R.id.ll_h);
        LinearLayout ll_m=view.findViewById(R.id.ll_m);
        LinearLayout ll_s=view.findViewById(R.id.ll_s);
        ll_d.setBackgroundColor(Color.parseColor(color));
        ll_h.setBackgroundColor(Color.parseColor(color));
        ll_m.setBackgroundColor(Color.parseColor(color));
        ll_s.setBackgroundColor(Color.parseColor(color));
    }
