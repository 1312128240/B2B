...
public class CountDownTimerView extends LinearLayout {
    ...
    public CountDownTimerView(Context context, AttributeSet attrs) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.view_countdowntimer, this);
        ...
        tv_h = view.findViewById(R.id.tv_hour);
        tv_m = view.findViewById(R.id.tv_minute);
        tv_s = view.findViewById(R.id.tv_second);
        ll_d = view.findViewById(R.id.ll_day);
        ll_h = view.findViewById(R.id.ll_h);
        ll_m = view.findViewById(R.id.ll_m);
        ll_s = view.findViewById(R.id.ll_s);
    }

    /**
     * 时分秒控件背景颜色
     */
    public void setLLColor(int  drawable) {
        ll_d.setBackgroundResource(drawable);
        ll_h.setBackgroundResource(drawable);
        ll_m.setBackgroundResource(drawable);
        ll_s.setBackgroundResource(drawable);
    }

    /**
     * 字的颜色
     */
    public void setCountDownTextColor(String color){
        tv_day_decade.setTextColor(Color.parseColor(color));
        tv_day_unit.setTextColor(Color.parseColor(color));
    ...
    public void setWidthHeight(int w,int h){
        ...
        ll_d.setLayoutParams(layoutParams);
        ll_h.setLayoutParams(layoutParams);
        ll_m.setLayoutParams(layoutParams);
        ll_s.setLayoutParams(layoutParams);
    }
    //隐藏秒
    public void setVisable(){
         ll_s.setVisibility(INVISIBLE);
         tv_s.setVisibility(VISIBLE);
         tv_m.setVisibility(INVISIBLE);
    }
