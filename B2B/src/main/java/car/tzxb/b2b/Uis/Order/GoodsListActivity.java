...
public class GoodsListActivity extends MyBaseAcitivity {
    ...
    private void initUI() {
         List<OrderBean.DataBean.GoodsBean> goodsBeanList=bean.getGoods();
        ...
        CommonAdapter<OrderBean.DataBean.GoodsBean> adapter=new CommonAdapter<OrderBean.DataBean.GoodsBean>(MyApp.getContext(),R.layout.order_list_item,goodsBeanList) {
            @Override
            protected void convert(ViewHolder holder, OrderBean.DataBean.GoodsBean goodsBean, int position) {
                     //店名
                holder.setText(R.id.tv_order_list_shopname,goodsBean.getShop_name());
                //内嵌布局
                ...
                CommonAdapter<OrderBean.DataBean.GoodsBean.DataChildBean> InnerAdapter=
                        new CommonAdapter<OrderBean.DataBean.GoodsBean.DataChildBean>(MyApp.getContext(),R.layout.commn_item,lists) {
                    @Override
